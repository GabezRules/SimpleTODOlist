...
class AddItemUsecase(private val repo: AppRepository): ActionOnItemUsecase {
    override suspend operator fun invoke(item: ItemTODO): Flow<ApiResponse> = repo.addItem(item)
}